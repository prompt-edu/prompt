        ...
        <div className='space-y-6 p-6'>
          ...
          <div className='grid gap-6 xl:grid-cols-2'>
            ...
            <div className='space-y-4'>
              <div className='space-y-1'>
                <h3 className='text-sm font-semibold text-slate-900'>
                  Assessor workflow visibility
                </h3>
                <p className='text-sm leading-6 text-slate-600'>
                  Control whether assessors can inspect related evaluation results before they
                ...
                {resultsReleased ? (
                  <div className='space-y-1'>
                    ...
                    <p className='text-sm leading-6 text-emerald-700'>
                      Students in this phase can already view the released assessment results based
                      on the visibility settings above.
                    </p>
                  </div>
                ) : (
                  <div className='space-y-4'>
                    <div className='space-y-1'>
                      ...
                      <p className='text-sm leading-6 text-slate-600'>
                        Release final assessment results to students after every assessment is
                        marked as final. This action cannot be undone.
                      </p>
                    </div>
