  ...
  return (
    <QueryGate
      ...
      errorFallback={({ refetch }) => (
        <ErrorPage message='Error loading configuration' onRetry={refetch} />
      )}
    >
      <div className='space-y-4'>
        ...
        {config?.hasDownloads && hasChanges && (
          <Alert variant='destructive'>
            ...
            <AlertDescription>
              Changing the template will affect all future downloads. Students who already
              downloaded their certificate will not automatically receive the updated version.
            </AlertDescription>
          </Alert>
        )}
