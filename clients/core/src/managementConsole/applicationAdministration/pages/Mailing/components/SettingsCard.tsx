      ...
      <CardContent className='space-y-6'>
        {someMailFunctionDisabled && (
          <div className='flex items-start space-x-2 text-sm text-muted-foreground bg-muted p-3 rounded-md'>
            ...
            <p>
              Some of the following mailing options are disabled. Please make sure to configure and
              save the corresponding mail subject and content.
            </p>
          </div>
        )}
          ...
          <div className='flex items-center justify-between'>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                {!automaticConfirmationMailEnabled && (
                  <TooltipContent>Confirmation mail subject or content is missing.</TooltipContent>
                )}
              </Tooltip>
            </TooltipProvider>
          </div>

          <ManualMailSending mailingMetaData={applicationMailingMetaData} isModified={isModified} />
        </div>
      </CardContent>
    </Card>
  )
