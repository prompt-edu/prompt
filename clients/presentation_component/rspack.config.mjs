...
const COMPONENT_NAME = 'presentation_component'
...
const config = (env = {}) => {
  ...
  return {
    ...
    resolve: { extensions: ['.ts', '.tsx', '.js', '.mjs', '.jsx'] },
    plugins: [
      ...
      new rspack.HtmlRspackPlugin({ template: 'public/template.html', minify: !IS_DEV }),
    ],
