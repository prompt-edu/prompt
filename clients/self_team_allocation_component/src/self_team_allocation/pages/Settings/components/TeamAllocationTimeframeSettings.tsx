...
interface TeamAllocationSettingsProps {
  teamAllocationTimeframe: Timeframe
}
...
export const TeamAllocationTimeframeSettings = ({
  ...
  const [startDateTime, setStartDateTime] = useState<string>(
    teamAllocationTimeframe.timeframeSet
      ? formatDateTimeForInput(teamAllocationTimeframe.startTime)
      : '',
  )
  const [endDateTime, setEndDateTime] = useState<string>(
    teamAllocationTimeframe.timeframeSet
      ? formatDateTimeForInput(teamAllocationTimeframe.endTime)
      : '',
  )
  ...
  return (
    <Card className='w-full'>
      <CardHeader>
        ...
        <CardDescription>
          Set the start/end date & time (with timezone handling) for the team allocation.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className='flex justify-end'>
            <Button
              ...
              disabled={
                ...
                (startDateTime === formatDateTimeForInput(teamAllocationTimeframe.startTime) &&
                  endDateTime === formatDateTimeForInput(teamAllocationTimeframe.endTime))
              }
