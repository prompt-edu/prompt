...
export const StudentSurveyPage = () => {
  ...
  const fetchedSurveyForm = surveyFormQuery.data
  const fetchedStudentSurveyResponse = studentSurveyResponseQuery.data
  const surveyStarted = fetchedSurveyForm !== null

  return (
    <QueryGate
      queries={[surveyFormQuery, studentSurveyResponseQuery]}
      loadingFallback={
