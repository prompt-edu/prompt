  ...
  plugins: [
    [
      "@docusaurus/plugin-content-docs",
      {
        ...
        editUrl: "https://github.com/prompt-edu/prompt/tree/main/docs/user/",
      },
    ],
    [
      "@docusaurus/plugin-content-docs",
      {
        ...
        sidebarPath: "./sidebars.js",
        editUrl:
          "https://github.com/prompt-edu/prompt/tree/main/docs/contributor/",
      },
    ],
    [
      "@docusaurus/plugin-content-docs",
      {
        ...
        routeBasePath: "admin",
        sidebarPath: "./sidebars.js",
        editUrl: "https://github.com/prompt-edu/prompt/tree/main/docs/admin/",
      },
    ],
  ],
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/prompt-edu/prompt/tree/main",
            label: "GitHub",
            position: "right",
          },
        ],
