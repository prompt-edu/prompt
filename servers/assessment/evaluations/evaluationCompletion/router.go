...
func RegisterRoutes(routerGroup *gin.RouterGroup, service *EvaluationCompletionService, authMiddleware func(allowedRoles ...string) gin.HandlerFunc) {
	...
	evaluationRouter.POST("/my-completion", audit.Describe("Saved my evaluation completion"), authMiddleware(promptSDK.CourseStudent), service.createOrUpdateMyEvaluationCompletion)
	evaluationRouter.PUT("/my-completion", audit.Describe("Saved my evaluation completion"), authMiddleware(promptSDK.CourseStudent), service.createOrUpdateMyEvaluationCompletion)
	evaluationRouter.POST("/my-completion/mark-complete", audit.Describe("Marked my evaluation as complete"), authMiddleware(promptSDK.CourseStudent), service.markMyEvaluationAsCompleted)
	evaluationRouter.PUT("/my-completion/unmark", audit.Describe("Unmarked my evaluation as complete"), authMiddleware(promptSDK.CourseStudent), service.unmarkMyEvaluationAsCompleted)
