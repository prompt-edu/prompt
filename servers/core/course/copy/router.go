...
// @Tags courses
// @Security BearerAuth
func RegisterRoutes(router *gin.RouterGroup, service *CourseCopyService) {
	setupCourseCopyRouter(router, service, keycloakTokenVerifier.KeycloakMiddleware, permissionValidation.CheckAccessControlByRole, checkAccessControlByIDWrapper)
}
