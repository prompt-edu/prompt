...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/execution.TriggerSummary"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "db.ResourceScope": {
            ...
            "x-enum-varnames": [
                "ResourceScopePerTeam",
                "ResourceScopePerStudent"
            ]
        },
        "db.ResourceStatus": {
            "type": "string",
        ...
        "execution.ResourceInstanceResponse": {
            ...
            "properties": {
                ...
                "resolvedName": {
                    "description": "ResolvedName is the name the provider was asked to create, so a failed row still\nsays which resource it was.",
                    "type": "string"
                },
                "resourceConfigId": {
                    "type": "string"
                ...
                "targetName": {
                    "description": "TargetName names the team or student the row is about, as core resolved it when the\ninstance last ran. Empty until then.",
                    "type": "string"
                },
                "teamId": {
                    "type": "string"
        ...
        "execution.TriggerSummary": {
            "type": "object",
            "properties": {
                "queued": {
                    "description": "Queued counts targets that had no instance yet.",
                    "type": "integer"
                },
                "requeued": {
                    "description": "Requeued counts failed or partial instances reset for another attempt.",
                    "type": "integer"
                },
                "upToDate": {
                    "description": "UpToDate counts targets whose resource was already created.",
                    "type": "integer"
                }
            }
        },
