...
const deleteStudentPreferencesByTeamType = `-- name: DeleteStudentPreferencesByTeamType :exec
...
type DeleteStudentPreferencesByTeamTypeParams struct {
	CourseParticipationID uuid.UUID `json:"course_participation_id"`
	CoursePhaseID         uuid.UUID `json:"course_phase_id"`
	TeamType              string    `json:"team_type"`
}

func (q *Queries) DeleteStudentPreferencesByTeamType(ctx context.Context, arg DeleteStudentPreferencesByTeamTypeParams) error {
	_, err := q.db.Exec(ctx, deleteStudentPreferencesByTeamType, arg.CourseParticipationID, arg.CoursePhaseID, arg.TeamType)
	return err
}
...
const deleteStudentSkillResponsesByPreferenceMode = `-- name: DeleteStudentSkillResponsesByPreferenceMode :exec
DELETE FROM student_skill_response
WHERE course_participation_id = $1
...
type DeleteStudentSkillResponsesByPreferenceModeParams struct {
	CourseParticipationID uuid.UUID `json:"course_participation_id"`
	CoursePhaseID         uuid.UUID `json:"course_phase_id"`
	PreferenceMode        string    `json:"preference_mode"`
}

func (q *Queries) DeleteStudentSkillResponsesByPreferenceMode(ctx context.Context, arg DeleteStudentSkillResponsesByPreferenceModeParams) error {
	_, err := q.db.Exec(ctx, deleteStudentSkillResponsesByPreferenceMode, arg.CourseParticipationID, arg.CoursePhaseID, arg.PreferenceMode)
	return err
}
...
const getStudentPreferencesByTeamType = `-- name: GetStudentPreferencesByTeamType :many
...
type GetStudentPreferencesByTeamTypeParams struct {
	CourseParticipationID uuid.UUID `json:"course_participation_id"`
	CoursePhaseID         uuid.UUID `json:"course_phase_id"`
	TeamType              string    `json:"team_type"`
}

type GetStudentPreferencesByTeamTypeRow struct {
	TeamID     uuid.UUID `json:"team_id"`
	Preference int32     `json:"preference"`
}

func (q *Queries) GetStudentPreferencesByTeamType(ctx context.Context, arg GetStudentPreferencesByTeamTypeParams) ([]GetStudentPreferencesByTeamTypeRow, error) {
	rows, err := q.db.Query(ctx, getStudentPreferencesByTeamType, arg.CourseParticipationID, arg.CoursePhaseID, arg.TeamType)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetStudentPreferencesByTeamTypeRow
	for rows.Next() {
		var i GetStudentPreferencesByTeamTypeRow
...
const getStudentSkillResponsesByPreferenceMode = `-- name: GetStudentSkillResponsesByPreferenceMode :many
SELECT skill_id, skill_level
FROM student_skill_response
JOIN skill ON skill.id = student_skill_response.skill_id
WHERE course_participation_id = $1
...
type GetStudentSkillResponsesByPreferenceModeParams struct {
	CourseParticipationID uuid.UUID `json:"course_participation_id"`
	CoursePhaseID         uuid.UUID `json:"course_phase_id"`
	PreferenceMode        string    `json:"preference_mode"`
}

type GetStudentSkillResponsesByPreferenceModeRow struct {
	SkillID    uuid.UUID  `json:"skill_id"`
	SkillLevel SkillLevel `json:"skill_level"`
}

func (q *Queries) GetStudentSkillResponsesByPreferenceMode(ctx context.Context, arg GetStudentSkillResponsesByPreferenceModeParams) ([]GetStudentSkillResponsesByPreferenceModeRow, error) {
	rows, err := q.db.Query(ctx, getStudentSkillResponsesByPreferenceMode, arg.CourseParticipationID, arg.CoursePhaseID, arg.PreferenceMode)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetStudentSkillResponsesByPreferenceModeRow
	for rows.Next() {
		var i GetStudentSkillResponsesByPreferenceModeRow
		if err := rows.Scan(&i.SkillID, &i.SkillLevel); err != nil {
			return nil, err
		}
		items = append(items, i)
...
func (q *Queries) InsertStudentSkillResponse(ctx context.Context, arg InsertStudentSkillResponseParams) error {
	_, err := q.db.Exec(ctx, insertStudentSkillResponse,
